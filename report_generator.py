...
class ReportGenerator:
    def __init__(self):
        ...
        self.logger = logging.getLogger('main_logger.ReportGenerator')
        self.entry_count = 0
    ...
    def add_entry(self, entry: Dict[str, Any]) -> None:
        ...
        self.logger.info(f"Item {self.entry_count}: Entry added successfully")
    ...
    def generate_report(self, filename: str = 'relatorio_registros.xlsx') -> None:
        ...
        try:
            ...
            self.logger.info(f"Report generated successfully: {filename}")
