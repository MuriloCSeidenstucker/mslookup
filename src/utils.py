...
class Utils:
    @classmethod
    def resize_window(self, driver: webdriver):
    ...
    @classmethod
    def remove_accents_and_spaces(self, input_str: str) -> str:
        return unidecode(input_str.replace(" ", "").lower()) if isinstance(input_str, str) else input_str
    
    @classmethod
    def calculate_elapsed_time(self, start_time: float, end_time: float) -> str:
