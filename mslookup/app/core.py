...
from mslookup.app.services.product_registration_service import ProductRegistrationService
...
class Core:
    ...
    def try_to_autocomplete_column_names(self, file_path):
        try:
            ...
            self.logger.error(f'Error detecting columns - {type(e)}')
            return None
